...
def check_performance():
    ...
    try:
        ...
        print(f"❌ ERRO: Arquivo não encontrado. Execute o pipeline de treino primeiro. Detalhes: {e}")
        return
    ...
    print("   (Quanto mais a curva se aproxima do canto superior esquerdo, melhor o modelo)")
    ...
    plt.figure(figsize=(8, 6))
    plt.plot(recall, precision, color='blue', lw=2, label=f'Curva P-R (AUC = {pr_auc:.2f})')
    ...
    print("   (Ideal para datasets desbalanceados. Quanto mais próxima do canto superior direito, melhor)")
